...
export const galleryItems = [
  { src: '/images/velask/t2/1.jpeg', alt: 'Cozinha integrada com bancada e zona de refeicoes', caption: 'Cozinha integrada' },
  { src: '/images/velask/t1/1.jpeg', alt: 'Sala com linhas limpas e solucoes de arrumacao', caption: 'Sala' },
  { src: '/images/velask/t3/1.jpeg', alt: 'Quarto com linguagem contemporanea e luz natural', caption: 'Quarto' },
  { src: '/images/velask/t3/2.jpeg', alt: 'Zona social com escada e arrumacao integrada', caption: 'Zona social duplex' },
  { src: '/images/velask/t3/3.jpeg', alt: 'Piso superior duplex: espaco extra com multiplos usos', caption: 'Piso superior duplex' },
  { src: '/images/velask/common/1.jpeg', alt: 'Casa de banho: revestimentos claros e movel suspenso', caption: 'Casa de banho' },
  { src: '/images/velask/common/9.jpeg', alt: 'Exterior: jardim com zona de lazer e apoio', caption: 'Exterior' },
  { src: '/images/velask/t2/3.jpeg', alt: 'Sala de estar com acabamentos contemporaneos', caption: 'Sala T2' },
  { src: '/images/velask/t1/3.jpeg', alt: 'Interior luminoso com areas abertas', caption: 'Interior T1' },
];

// --- Counters (Bug #05 — correct stats) ---

export const counters = [
  { value: '3', suffix: '', label: 'Apartamentos' },
  { value: '353', suffix: 'm\u00B2', label: 'Area bruta total' },
  { value: '2026', suffix: '', label: 'Reabilitacao completa' },
];
...
export const units = [
  ...
  },
  {
    ...
    title: 'T3 Duplex',
    area: '108,67 m\u00B2',
    summary: 'Duplex com piso extra: espaco para familia + trabalho + lazer.',
    specs: [
    ...
    copy: [
      ...
      'Se queres um T3 mas nao queres monotonia, esta e a unidade com personalidade: o piso superior muda completamente o jogo do espaco.',
    ],
...
// --- Location accordion data (Bug #08 — new structure) ---
...
export const locationAccordion = [
  {
    ...
    title: 'Transportes',
    items: [
      'Metro Estadio do Dragao (A, B, E, F) — 3 min a pe',
      'Campanha (comboio intermodal) — 10 min a pe',
  ...
  },
  {
    ...
    title: 'Comercio',
    items: [
      'Alameda Shop & Spot (Continente, Fnac, 7 salas NOS) — 5 min a pe',
      'Comercio de bairro (cafe, farmacia, padaria) — no bairro',
    ],
  },
  {
    icon: '\uD83C\uDFE5',
    ...
    items: [
      ...
      'Hospital Sao Joao — 15 min de carro',
    ],
  },
  {
    icon: '\uD83C\uDFEB',
    title: 'Ensino',
    items: [
      'Escolas em Campanha e Bonfim — bairro',
      'ISEP — 15 min',
...
export const locationCards = [
  { num: '01', title: 'Transportes', desc: 'Metro Estadio do Dragao a 3 min a pe. Campanha (comboio intermodal) a 10 min. Aeroporto via metro linha E em 25 min.' },
  ...
  { num: '04', title: 'Servicos do dia a dia', desc: 'Alameda Shop & Spot a 5 min a pe. Comercio de bairro (cafe, farmacia, padaria) na envolvente.' },
...
export const faqItems = [
  ...
  { q: 'O que inclui a "area bruta" de cada unidade?', a: 'Cada unidade integra componentes diferentes (ex.: garagem, anexo, duplex). Por isso mostramos a decomposicao completa na brochura.' },
  { q: 'O piso superior do duplex conta como area habitacional?', a: 'Depende do licenciamento e do pe-direito/condicoes. Esclarecemos isso no processo (e deve estar refletido no CPCV).' },
