/**
 * Portfolio Detail Page - Layout Moderno e Clean
 * 100% Conforme Guardião Universal com todos os conteúdos editáveis no admin
 */
...
// Mock data de projetos (fallback)
...
export function PortfolioDetailPage() {
  ...
  const { project, isLoading, error } = useProjectFetch(params.id, {
  ...
  // Debug: verificar se os links estão presentes
  console.log('[PortfolioDetailPage] Project data:', {
    id: project.id,
    title: project.title,
      ...
      <div ref={ref}>
        ...
        <Section background="muted">
          <Container>
            ...
            >
              {/* Coluna Esquerda: Descrição e Highlights */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                  ...
                  <div style={{ marginBottom: designSystem.spacing[8] }}>
                    <h2
                      style={{
                        ...
                        fontSize: isMobile ? designSystem.typography.fontSize['2xl'] : undefined,
                      }}
                    >
                      Sobre o Projeto
                    </h2>
                        ...
                        >
                          <div
                            style={{
                              ...
                              background: `${designSystem.colors.brand.secondary}15`,
              ...
              >
                <div
                  style={{
                    ...
                    top: isMobile ? 'auto' : designSystem.spacing[24],
                  }}
                >
                  <h3
                    style={{
                      color: designSystem.colors.neutral[900],
                      marginBottom: designSystem.spacing[6],
                      fontSize: isMobile ? designSystem.typography.fontSize.xl : undefined,
                    }}
                  >
                    Características
                  </h3>
                    ...
                    <div style={{ marginTop: designSystem.spacing[6], paddingTop: designSystem.spacing[6], borderTop: `1px solid ${designSystem.colors.neutral[200]}` }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: designSystem.spacing[2] }}>
                        {project.portalLink && (
                          <Button
                            variant="default"
                            onClick={() => window.open(project.portalLink!, '_blank')}
                            style={{
                              width: '100%',
            ...
            <Container>
              ...
              >
                ...
                <div
                  style={{
                    display: 'grid',
                    gridTemplateColumns: isMobile ? '1fr' : `repeat(${project.timeline.length}, 1fr)`,
                    gap: designSystem.spacing[4],
                  }}
                >
                    ...
                    <motion.div
                      ...
                      style={{
                        ...
                        background: phase.status === 'completed' 
                          ? `${designSystem.colors.brand.secondary}05`
                          : designSystem.colors.neutral[50],
                        border: `2px solid ${phase.status === 'completed' 
              ...
              >
                ...
                >
                  <FinancialMetricCard
                    ...
                    value={project.financials.total}
                    breakdown={[
                      { label: 'Aquisição', value: project.financials.acquisition },
                      { label: 'Renovação', value: project.financials.renovation },
                    ]}
                  />
                  <FinancialMetricCard
                    label="Valor de Venda"
                    value={project.financials.sale}
                    highlight
                  />
                  <FinancialMetricCard
                    label="Lucro Líquido"
                    value={project.financials.profit}
                    subtitle={`ROI: ${project.financials.roi}`}
                    success
                  />
                </div>

                {/* Links Externos - Componente Premium */}
                <ExternalLinksCard 
                  portalLink={project.portalLink}
                  brochureLink={project.brochureLink}
                  animated={true}
        ...
        <RelatedProjects currentProjectId={project.id} currentStatus={project.status} isMobile={isMobile} navigate={navigate} />
      </div>
    </PageTransition>
  );
}

// Componente de Projetos Relacionados
function RelatedProjects({ 
  ...
  isMobile: boolean;
  navigate: (route: any, params?: any) => void;
}) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.success && data.projects) {
            // Filtrar: mesmo status ou disponível, excluir projeto atual
            const filtered = data.projects
              .filter((p: Project) => 
                p.id !== currentProjectId && 
                (p.status === currentStatus || p.status === 'available')
              )
              .slice(0, 4); // Máximo 4 projetos
          ...
          >
            {relatedProjects.map((project, index) => (
              <motion.div
                ...
                onClick={() => navigate('portfolio-detail', { id: project.id })}
                style={{
                  background: designSystem.colors.neutral.white,
                  borderRadius: designSystem.borderRadius['2xl'],
                  overflow: 'hidden',
...
// Componente auxiliar para Métrica
    ...
    <div
      style={{
        ...
        background: highlight 
          ? `linear-gradient(135deg, ${designSystem.colors.brand.secondary}15, ${designSystem.colors.brand.secondary}05)`
          : designSystem.colors.neutral.white,
        border: `1px solid ${highlight ? designSystem.colors.brand.secondary : designSystem.colors.neutral[200]}`,
        borderRadius: designSystem.borderRadius.lg,
        textAlign: 'center',
      }}
    >
      <div
        style={{
          color: highlight ? designSystem.colors.brand.secondary : designSystem.colors.neutral[600],
          marginBottom: designSystem.spacing[2],
          display: 'flex',
          justifyContent: 'center',
        }}
      ...
      <div
        style={{
          fontSize: designSystem.typography.fontSize.xl,
          fontWeight: designSystem.typography.fontWeight.bold,
          color: highlight ? designSystem.colors.brand.secondary : designSystem.colors.neutral[900],
        }}
      >
        {value}
      </div>
...
// Componente auxiliar para linha de característica
...
function CharacteristicRow({ icon, label, value }: CharacteristicRowProps) {
  return (
    <div
    ...
    >
      <div className="inline-flex items-center gap-3">
        <div style={{ color: designSystem.colors.neutral[400] }}>
          {icon}
        </div>
        <span
          style={{
...
// Componente auxiliar para card financeiro
...
function FinancialMetricCard({ label, value, subtitle, breakdown, highlight, success }: FinancialMetricCardProps) {
  return (
    <motion.div
      whileHover={{ y: -4 }}
      ...
      style={{
        padding: designSystem.spacing[6],
        background: highlight 
          ? `linear-gradient(135deg, ${designSystem.colors.brand.secondary}, ${designSystem.colors.brand.secondary}dd)`
          : designSystem.colors.neutral.white,
        borderRadius: designSystem.borderRadius.xl,
        boxShadow: designSystem.shadows.md,
        textAlign: 'center',
    ...
    >
      <div
        style={{
          fontSize: designSystem.typography.fontSize.sm,
          color: highlight ? designSystem.colors.neutral.white : designSystem.colors.neutral[600],
      ...
      <div
        style={{
          ...
          marginBottom: subtitle || breakdown ? designSystem.spacing[3] : 0,
        }}
      >
        {value}
      </div>
      ...
      {subtitle && (
        <div
          style={{
            fontSize: designSystem.typography.fontSize.sm,
            fontWeight: designSystem.typography.fontWeight.semibold,
            color: highlight ? designSystem.colors.neutral.white : designSystem.colors.brand.secondary,
          }}
        >
          {subtitle}
        </div>
